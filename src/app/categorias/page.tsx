        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          <Card className="bg-gradient-to-br from-yellow-50 to-yellow-100 border-yellow-200 dark:from-slate-700/50 dark:to-slate-600/50 dark:border-slate-600">
            <CardContent className="py-1 px-3">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-yellow-600 dark:text-yellow-400 text-sm font-medium">Con Prompts</p>
                  <p className="text-2xl font-bold text-yellow-900 dark:text-yellow-100">{stats.categoriasUsadas}</p>
                </div>
            ...
            <CardContent className="py-1 px-3">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-green-900 dark:text-green-100">{stats.categoriasRecientes}</p>
                </div>
